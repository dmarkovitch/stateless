...
namespace Stateless
{
	public partial class StateMachine<TState, TTrigger>
	{
		...
		public class StateConfiguration
		{
			...
			{
				Enforce.ArgumentNotNull(exitAction, "entryAction");
				_representation.AddExitAction((t, args) => exitAction(t));
				return this;
			}
			...
			/// <param name="trigger">The trigger by which the state must be entered in order for the action to execute.</param>
			/// <returns>The receiver.</returns>
			public StateConfiguration OnExitFrom(TTrigger trigger, Action exitAction)
			{
				Enforce.ArgumentNotNull(exitAction, "exitAction");
				return OnExitFrom(trigger, t => exitAction());
			}
			...
			/// <param name="trigger">The trigger by which the state must be entered in order for the action to execute.</param>
			/// <returns>The receiver.</returns>
			public StateConfiguration OnExitFrom(TTrigger trigger, Action<Transition> exitAction)
			{
				Enforce.ArgumentNotNull(exitAction, "exitAction");
				_representation.AddExitAction(trigger, (t, args) => exitAction(t));
				return this;
			}
			*/
